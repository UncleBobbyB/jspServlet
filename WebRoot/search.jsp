<%@ page language="java" import="java.util.*" import="jspservlet.vo.Product" pageEncoding="ISO-8859-1"%>
<%
String path = request.getContextPath();
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
%>
<%ArrayList<Product> proList = (ArrayList<Product>) session.getAttribute("pro"); %>
<!DOCTYPE HTML>
<html>
      ...
      <div class="shop_top">
        <div class="container">
          <div class="row shop_box-top">
            <div class="col-md-3 shop_box"><a href="single1.html">
                <img src=<%String stri = (String)pro.getImage(); %>
                  <%= stri %> class="img-responsive" alt="" style="height:140px; width:270px;"/>
                <span class="new-box">
                ...
                <div class="shop_desc">
                  <h3><a href="#">
                  <%String str = (String)pro.getName(); %>
                  <%= str %>
                  </a></h3>
                 
                 
                  <span class="actual">$<%String strp = (String)pro.getPrice(); %>
                  <%= strp %></span><br>
                  <ul class="buttons">
